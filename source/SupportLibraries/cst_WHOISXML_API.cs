...
namespace CheccoSafetyTools
{
	...
	{
        private static String API_KEY = OutlookSafetyChecks.Properties.Settings.Default.WhoisXml_ApiKey;
		...
		private readonly static String GEOIP_URL = "https://geoipify.whoisxmlapi.com/api/v1?outputFormat=JSON&apiKey=" + API_KEY + "&";
